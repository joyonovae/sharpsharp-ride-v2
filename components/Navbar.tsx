        ...
        <div className="flex items-center gap-3">
          {!loading && user ? (
            <div className="relative hidden md:block">
              ...
              {accountOpen && (
                <div className="absolute right-0 mt-3 w-68 overflow-hidden rounded-2xl border border-white/10 bg-[#0b1d26]/95 shadow-[0_20px_60px_rgba(0,0,0,0.45)] backdrop-blur-xl">
